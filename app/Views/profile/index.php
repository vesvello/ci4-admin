    ...
    <section class="bg-white border border-gray-200 rounded-xl shadow-sm p-5">
        ...
        <?php if ($isAdmin): ?>
            <form method="post" action="<?= site_url('profile') ?>" class="mt-4 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700" for="first_name"><?= lang('Profile.first_nameLabel') ?></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700" for="last_name"><?= lang('Profile.last_nameLabel') ?></label>
        ...
        <?php else: ?>
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700"><?= lang('Profile.first_nameLabel') ?></label>
                    <p class="mt-1 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-800"><?= esc($user['first_name'] ?? '') ?></p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700"><?= lang('Profile.last_nameLabel') ?></label>
