    ...
    <form method="post" action="<?= site_url('admin/users') ?>" class="mt-4 space-y-4">
        ...
        <div>
            ...
            <select id="role" name="role" required
                ...
                <option value="user" <?= old('role', 'user') === 'user' ? 'selected' : '' ?>><?= lang('Users.user_role') ?></option>
                <option value="admin" <?= old('role') === 'admin' ? 'selected' : '' ?>><?= lang('Users.admin_role') ?></option>
                <option value="superadmin" <?= old('role') === 'superadmin' ? 'selected' : '' ?>><?= lang('Users.super_admin_role') ?></option>
            </select>
